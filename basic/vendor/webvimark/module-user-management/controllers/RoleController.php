...
class RoleController extends AdminDefaultController {
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post()) AND $model->save(FALSE)) {
            return $this->redirect(['view', 'id' => $model->name]);
        }
    ...
    public function actionGetUsersFromRoles($role = array()) {
        $users = \app\models\User::findActiveUsersByRole($role);
